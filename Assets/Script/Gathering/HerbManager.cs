...
// {
//     public List<HerbStateData> herbs = new List<HerbStateData>();
// }
...
// {
//     public static HerbManager Instance { get; private set; }

//     [Serializable]
//     public class HerbState
//     {
//         public bool isTaken;
//         public int dayTaken;
//     }
...
//     [SerializeField]
//     private Dictionary<string, HerbState> herbStates = new();
...
//     public HerbState GetState(string herbID)
//     {
//         if (!herbStates.TryGetValue(herbID, out HerbState state))
//         {
//             state = new HerbState();
...
//     public void SetState(string herbID, bool taken, int day)
//     {
//         HerbState state = GetState(herbID);
//         state.isTaken = taken;
//         state.dayTaken = day;
//     }

//     public Dictionary<string, HerbState> GetAllStates()
//     {
//         return herbStates;
//     }

//     public void SetAllStates(Dictionary<string, HerbState> states)
//     {
//         herbStates = states ?? new Dictionary<string, HerbState>();
//     }
...
//         foreach (var pair in HerbManager.Instance.GetAllStates())
//         {
//             save.herbs.Add(new HerbEntry
//             {
//                 herbID = pair.Key,
//                 taken = pair.Value.isTaken,
//                 dayTaken = pair.Value.dayTaken
//             });
//         }
//     }
...
//     private void Load()
//     {
//         Dictionary<string, HerbManager.HerbState> states = new();

//         foreach (var herb in save.herbs)
//         {
//             states.Add(herb.herbID, new HerbManager.HerbState
//             {
//                 isTaken = herb.taken,
//                 dayTaken = herb.dayTaken
//             });
//         }

//         HerbManager.Instance.SetAllStates(states);
//     }
// }
using System;
using System.Collections.Generic;
